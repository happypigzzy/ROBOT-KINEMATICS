function [ joints, s_mat, w_mat ] = InverseKinematics( pose, nsparam, rconf )
% INVERSEKINEMATICS
%
...
% Attention: run ForwardKinematics first,get nsparam, rconf ,then run this
...
[~, R03_o, ~] = ReferencePlane(pose, elbow);
